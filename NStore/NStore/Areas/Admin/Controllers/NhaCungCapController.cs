...
namespace NStore.Areas.Admin.Controllers
{
    ...
    public class NhaCungCapController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,tenNhaCungCap,email,soDienThoai,diaChi")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,tenNhaCungCap,email,soDienThoai,diaChi")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
